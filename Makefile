...
# This one is stolen from https://github.com/cyrozap/ghidra-md32
#   or somewhere else in cyrozap's repos ---(i have no effort to stole from the source instead!)
...
SLA_SRCS := $(LANGDIR)/NDS32.slaspec $(wildcard $(LANGDIR)/*.sinc)
SLA := $(LANGDIR)/NDS32.sla
